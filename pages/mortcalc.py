...
class ZillowMortgageCalculatorPage:
    ...
    l_errormsg_interestrate_class = (
        By.CLASS_NAME, "StyledFormHelp-c11n-8-64-1__sc-h3s6hy-0.lfSzwh")
    l_label_interestrate_id = (By.ID, 'label_4')
    # TODO: so far can;t crack this class failure
    l_link_currentrates_class = (
        By.CLASS_NAME, "StyledTextButton-c11n-8-64-1__sc-n1gfmh-0.fiChL")
    l_link_currentrates_xpath = (
        By.XPATH, "(// a[normalize-space() = 'See current rates'])[1]")
    l_text_monthlypayment_class = (
    ...
    l_title_interestratehelptooltip_class = (
        By.CLASS_NAME, "DialogHeader-c11n-8-64-1__sc-1nk3a2m-0.OfDZV")
    l_tooltip_x_interestratehelp_class = (
        By.CLASS_NAME, "DialogClose-c11n-8-64-1__sc-1t0puoj-0.jPlnfQ")
    ...
    def _type_entry(self, value, element):
        ...
        theResultingMonthly = self.browser.find_element(
            *self.l_text_monthlypayment_class)
    ...
    def click_test_help_button(self):
        ...
        irate_help_button = self.browser.find_element(
            *self.l_button_interestratehelp_class)
    ...
    def get_test_help_button_title(self):
        ...
        irate_help_tooltip_title = self.browser.find_element(
            *self.l_title_interestratehelptooltip_class)

        print(f"found test help button title {irate_help_tooltip_title.text}")
    ...
    def click_test_help_button_tooltip_x(self):
        ...
        irate_help_tooltip = self.browser.find_element(
            *self.l_tooltip_x_interestratehelp_class)
